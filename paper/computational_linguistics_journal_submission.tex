...
\title{\Large\bfseries Plot-Level Semantic Similarity Detection in Literary Texts:\\
...
$^2$Collaborator Institution \\
\texttt{collab.email@institution.edu}
}
...
\noindent\textbf{Keywords:} sentence embeddings, semantic similarity, plot detection, literary text analysis, document-level semantics, benchmark dataset, Universal Sentence Encoder
...
\textbf{Reproducibility:} Fixed random seeds (42 for all libraries). Code and data released at \url{https://github.com/[your-username]/An-Adaptive-Methodology}.
...
\url{https://github.com/[your-username]/An-Adaptive-Methodology}
